...
function Inner() {
  ...
  const overviewQuery = useQuery({
    ...
    queryFn: () =>
      getJson<ResponseTimeOverview>(`/api/response-time/overview?filters=${filterParam}`),
    staleTime: 30_000,
  });
    ...
    <div className="p-6 space-y-6">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <KpiCard
          ...
          value={overviewQuery.data?.summary.medianHours != null ? formatHours(overviewQuery.data.summary.medianHours) : '—'}
          subtitle="50th percentile"
          positiveIsGood={false}
        />
        <KpiCard
          label="AVG RESOLUTION TIME"
          value={overviewQuery.data?.summary.avgHours != null ? formatHours(overviewQuery.data.summary.avgHours) : '—'}
